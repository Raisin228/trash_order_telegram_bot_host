START_USER_TEXT = """Добро пожаловать в <b>"Бургеромант и Событиявизор"</b> 🍔🎉
...
"""
HELP_USER_TEXT = """
• <b>/start</b> - Начать волшебное путешествие в мир <b>"Бургеромант и Событиявизор"</b>. Здесь ты найдешь вкуснейшие 
